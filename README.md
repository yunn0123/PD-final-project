# PD 112-1 final project: group 35
## 注意事項
1. `.txt`檔應為ANSI
2. 程式檔應為Big5(cp950) (如果有含中文的程式檔可能因為預設為utf-8而亂碼，請改為Big5)
3. 因為有多個檔案一起編譯的緣故，若要執行程式，請在terminal執行cmd:
    ```
    cd ./project_group35
    g++ mainFunc.cpp item.cpp character.cpp card.cpp description.cpp game1.cpp ending.cpp
    ./a.exe
    ```
# Card
## 主要說明
...
- 儲存方式(`event.txt`)
    ...
    [名稱 問題 左邊選項 右邊選項 左邊選項導向的問題 右邊選項導向的問題]
    [名稱 問題2(左邊) ...(與上述相同)]
    [名稱 問題2(右邊) ...]
    ...
    [事件結束語 0]
